...
public:
  ...
  void optimize()
	...
	void evaluate_only_residual(const vector_quad& poses_, const vector_vec3d& ts_, double& residual)
	{
		residual = 0;
		size_t voxel_size = origin_points.size();
...
static void cut_voxel(std::unordered_map<VOXEL_LOC, OCTO_TREE*>& feature_map,
               ...
               const Eigen::Matrix4d& pose, int f_head, 
							 int window_size, double voxel_size, double eigen_threshold)
{
